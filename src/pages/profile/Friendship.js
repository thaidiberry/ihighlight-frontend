    ...
    <div className="friendship">
      {friendship?.friends ? (
        ...
        !friendship?.requestReceived && (
          <button className="black_btn" onClick={() => addFriendHandler()}>
      ...
      {friendship?.requestSent ? (
        <button className="black_btn" onClick={() => cancelRequestHandler()}>
          <img
      ...
      <div className="flex">
        {friendship?.following ? (
          ...
          <button className="black_btn" onClick={() => followHandler()}>
